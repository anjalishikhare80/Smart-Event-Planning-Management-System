...
KNOWLEDGE = {
    ...
    "receipt": {
        "patterns": [
            ...
            "proof of registration", "ticket download",
    ...
    "certificate": {
        "patterns": [
            "certificate", "certificate of participation", "download certificate",
            "how do i get my certificate", "get certificate", "unlock certificate",
            "certificate not available", "certificate locked", "why cant i download certificate",
            "certificate nahi mil raha"
        ],
        "responses": {
            "Guest":       "Certificates of Participation are available to Participants after attending a registered event. Sign up to get started.",
            "Admin":       "Certificates unlock automatically once all 3 conditions are met for a registration: (1) the event status is 'Completed', (2) the Organizer has marked the participant as attended, (3) the participant has submitted feedback. You can review feedback per event from the event's 'Feedback' button.",
            "Organizer":   "Participants can only download a Certificate once you've marked them 'Attended' for a completed event (via the Participants panel checkbox, or by scanning their check-in QR code) AND they've submitted feedback. Marking attendance is the step in your control.",
            "Participant": "To download your Certificate of Participation, all 3 must be true:\n1. The event has moved to 'Completed' status\n2. The Organizer has marked you as 'Attended'\n3. You've submitted feedback for the event (rate it from 'Completed Events')\n\nOnce all three are done, a 'Certificate' button appears next to 'Receipt' in your Completed Events section. If you don't see it yet, check which of these steps is still missing — most often it's waiting on the organizer to mark attendance."
        },
        "suggestions": ["How do I submit feedback?", "What is check-in QR code?"]
    },

    "checkin_qr": {
        "patterns": [
            "qr code", "check in qr", "checkin qr", "show qr", "scan qr",
            "qr code check in", "how does qr check in work", "qr not working"
        ],
        "responses": {
            "Guest":       "QR check-in lets Organizers mark Participants as attended by scanning a code at the event. Sign up as a Participant to receive one for your registered events.",
            "Admin":       "Each registration has a signed QR code participants can show at entry. Organizers scan it with their phone's camera to mark attendance instantly — it's an alternative to manually checking a box in the Participants panel.",
            "Organizer":   "In the Participants panel for any event, you can either manually check the 'Attended' box, or scan a participant's QR code with your phone's normal camera app to check them in instantly. Note: your phone needs to be able to reach the server (same network, or a real deployed domain) for the scan to work.",
            "Participant": "You'll find a 'Show Check-in QR' button on each event in your 'Upcoming Events' section. Show this to the organizer at the event entrance — they'll scan it with their phone to mark you attended, which is one of the steps needed to unlock your certificate afterward."
        },
        "suggestions": ["How do I get my certificate?", "How do I submit feedback?"]
    },

    "feedback": {
        "patterns": [
            "submit feedback", "give feedback", "rate event", "rate the event",
            "how do i submit feedback", "leave a review", "edit feedback",
            "change my rating", "feedback nahi ho raha"
        ],
        "responses": {
            "Guest":       "Feedback can be submitted by Participants after attending an event, as part of unlocking their Certificate of Participation.",
            "Admin":       "Participants submit a 1–5 star rating plus optional comments per registration, once the organizer has marked them attended for a completed event. You can view all feedback for an event from the organizer's dashboard 'Feedback' button.",
            "Organizer":   "Once you've marked a participant 'Attended' for a completed event, they can rate it from their dashboard. You can view everyone's ratings and comments for an event via the 'Feedback' button on that event's card.",
            "Participant": "For a completed event where you've been marked 'Attended', click 'Rate & Unlock' in your Completed Events section. Pick a star rating (required) and an optional comment, then submit — this immediately unlocks your Certificate download. You can also edit your feedback anytime afterward via 'Edit my feedback'."
        },
        "suggestions": ["How do I get my certificate?", "What is check-in QR code?"]
    },
